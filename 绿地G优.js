 ...
 * 绿地G优app签到，获得签到积分和碎片，兑换商品
 
 * 注册地址：https://tinyurl.com/4dyykr78   备用地址：https://gu.gkewang.com/front/inviter/register/00bqnz6z?activityCode=INVITECLIE

 * ========= 青龙--配置文件 =========
 * 变量名: ldgy_hd     变量值：手机号&token   ,多账号用 换行 或 @ 分割
 * 抓域名app.gkewang.com下的请求body 的token值
 * 如果是这种格式   %22token%22:%22XXXXXXXXXXXXXXXXXX%22 (只需要XXXXXXXXXXXXXX这部分)
 * token有效期未知，一旦抓包不可退出登陆，否则token失效
 ...
 */
 ...
 async function tips(ckArr) {
	 DoubleLog (`\n脚本仓库：https://wwgz.lanzoue.com/b0ec064he`);
	 DoubleLog(`\n密码: 2580`);
