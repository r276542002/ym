    ...
    if (typeof $request !== "undefined") {
        ...
        if (!(await Envs()))
            ...
            for (let index = 0; index < jiekahdArr.length; index++) {
               ...
               await ota('userScore/get','{}') 
            //    await ota('add','{"postId":"1742862541916213250","commentId":"","content":"666","attachments":""}')
               await ota('userScore/get','{}') 
            //    await ota('add','{"postId":"1742862541916213250","commentId":"","content":"666","attachments":""}')
               await ota('userScore/get','{}')                                                         
            ...
            //    await ota('forum/add','{"postType":"","title":"我爱节卡机器人","content":"我爱节卡机器人","attachments":";;"}')
               ...
               for( code of share){
                    ...
                    await ota('forum/share',`{"sharedPath":"packages/service/pages/newOnline/index","id":"1742862541916213250"}`)
                    await ota('userScore/get','{}')                    
               }
               await user('user/getWXUserInfo','{}')
